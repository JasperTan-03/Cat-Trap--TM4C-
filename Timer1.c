...
volatile int delay;
  ...
  NVIC_PRI5_R = (NVIC_PRI5_R&0xFFFF00FF)|(priority<<13); // priority is bits 15,14,13 for 1A
// interrupts enabled in the main program after all devices initialized
// vector number 37, interrupt number 21
	NVIC_PRI5_R = (NVIC_PRI5_R&0xFFFF00FF)|(priority<<13); // priority is bits 23, 22, 21 for 1B 
