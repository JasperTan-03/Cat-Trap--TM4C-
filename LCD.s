...
checkHigh 
	LDR R5, [R4]
	AND R5, #0x10 ;0001 0000 step 1
	CMP R5, #0
	BNE checkHigh; step 2
	
	LDR R6, =GPIO_PORTA_DATA_R
	LDR R7, [R6]
	AND R7, #0xBF ;1011 1111 step 3
	STR R7, [R6]
...
checkAgain 
	LDR R5, [R4]
	AND R5, #0x10 ;0001 0000 step 5
	CMP R5, #0
	BNE checkAgain ;step 6
...
checkBit1
	LDR R5, [R4]
	AND R5, #0x02 ;0000 0010 step 1
	CMP R5, #0
	BEQ checkBit1 ;step 2
    
	LDR R6, =GPIO_PORTA_DATA_R
	LDR R7, [R6]
	ORR R7, #0x40 ;0100 0000 set PA6
	STR R7, [R6] ;step 3
